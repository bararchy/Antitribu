//Tracker scheme resource file  sections: Colors   - all the colors used by the scheme BaseSettings - contains settings for app to use to draw controls Fonts   - list of all the fonts used by app Borders   - description of all the borders
Scheme 
{
...
//		"ControlDarkBG" "40 30 21 255"		// darker background color; used for background of scrollbars
	...
	BaseSettings
	{
		...
		"TitleBarIcon"				"resource/icon_vconfig"
		"TitleBarDisabledIcon"		"resource/icon_vconfig"
