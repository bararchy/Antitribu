...
#        world.SetSafeArea(0)
    ...
    if G.Patch_Plus == 1:
        cross = Find("crossbow")
        crossnode = Find("crossnode")
        if cross: cross.ScriptUnhide()
        if crossnode: crossnode.ScriptUnhide()
...
#F.U. SYNDICATE:  starts and restarts the lasers (thanks to stealing Jocelyn code and modifying it).
...
def killedMandarin():
    Find("last_guard1").ScriptUnhide()
    Find("last_guard2").ScriptUnhide()
    Find("FuExplosive_bot3").ScriptUnhide()
...
#-------------------------------------------------------------
#ANTITRIBU: explosive_bot 1 
def BotFuExplode():
    xyz1 = Find("FuExplosive_bot").GetOrigin()
    Find("BotFuExplode").SetOrigin(xyz1)
    __main__.ScheduleTask(0.1,"BotFuExplode1()")

def BotFuExplode1():
    Find("BotFuExplode").Explode()

#ANTITRIBU: explosive_bot 2 
def Bot2FuExplode():
    xyz2 = Find("FuExplosive_bot2").GetOrigin()
    Find("Bot2FuExplode").SetOrigin(xyz2)
    __main__.ScheduleTask(0.1,"Bot2FuExplode1()")

def Bot2FuExplode1():
    Find("Bot2FuExplode").Explode()

#ANTITRIBU: explosive_bot 3 
def Bot3FuExplode():
    xyz3 = Find("FuExplosive_bot3").GetOrigin()
    Find("Bot3FuExplode").SetOrigin(xyz3)
    __main__.ScheduleTask(0.1,"Bot3FuExplode1()")

def Bot3FuExplode1():
    Find("Bot3FuExplode").Explode()
#-------------------------------------------------------------
