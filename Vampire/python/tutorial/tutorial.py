...
## set file for clan specific popups blood_healing fortitude
def SetClanPopups():
	...
	SetActivePopup("obtenebration", player.base_blood_healing, popupdisc1, popupdisc12, popupdisc1fail)
        ...
        SetActivePopup("serpentis", player.base_animalism, popupdisc3, popupdisc32, popupdisc3fail)
    elif(clan == 4):
        popupclan.ChangeFile(popuppath + "malkaviandisc1.txt")
        SetPassivePopup("auspex", popupdisc1, popupdisc12, popupdisc1fail)
        SetActivePopup("animalism", player.base_corpus_vampirus, popupdisc2, popupdisc22, popupdisc2fail)
        SetActivePopup("dominate", 1, popupdisc3, popupdisc32, popupdisc3fail)
        popup = Find("popup_59")
        popup.ChangeFile(popuppath + "dialogue_dominate.txt")
    elif(clan == 5):
        popupclan.ChangeFile(popuppath + "nosferatudisc1.txt")
	SetActivePopup("protean", player.base_protean, popupdisc1, popupdisc12, popupdisc1fail)
        SetObfuscatePopup(player.base_obfuscate, popupdisc2, popupdisc22, popupdisc2fail)
        SetActivePopup("thaumaturgy", player.base_thaumaturgy, popupdisc3, popupdisc32, popupdisc3fail)
        SetObfuscateDisc2()
        popup = Find("popup_59")
	...
	SetActivePopup("protean", player.base_protean, popupdisc1, popupdisc12, popupdisc1fail)
        SetPassivePopup("auspex", popupdisc2, popupdisc22, popupdisc2fail)
        SetActivePopup("nihilistics", player.base_fortitude, popupdisc3, popupdisc32, popupdisc3fail)
    elif(clan == 8):
