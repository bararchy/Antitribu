...
def nosferatuRevealer():
    ...
    if(clan == 5):
        ...
        if(__main__.FindPlayer().IsMale()):
            sire.SetModel("models/character/pc/female/samedi/samedi_female_armor0.mdl")
        else:
            sire.SetModel("models/character/pc/male/samedi/samedi_male_armor0.mdl")
...
#SP_THEATRE : Remove a webcam from your inventory, changed by wesp
def removeCamera():
    pc = __main__.FindPlayer()
...
def castUnderstudy():
    ...
    if(clan == 5):
        if(pc.IsMale()):
            understudy.SetModel("models/character/pc/male/malkavian/armor0/malkavian_male_armor_0.mdl")
        else:
            understudy.SetModel("models/character/pc/female/malkavian/armor0/malkavian_female_armor_0.mdl")
    else:
...
def nosferatuTransform():
    ...
    if(clan == 5):
        if(pc.IsMale()):
            understudy.SetModel("models/character/pc/male/samedi/samedi_male_armor0.mdl")
        else:
            understudy.SetModel("models/character/pc/female/samedi/samedi_female_armor0.mdl")
